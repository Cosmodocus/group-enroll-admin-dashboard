          ...
          >
            {!isCollapsed && (
              <Box display={"flex"} justifyContent={"space-between"} alignItems={"center"} ml={"10px"}>
                <img src={GroupEnroll} color={colors.grey[100]} style={{ width: "170px", height: "30px" }} />
                <IconButton onClick={handleCollapse} sx={{ ml: "1px" }}>
                  <MenuOutlinedIcon />
                </IconButton>
              </Box>
            )}
          ...
          {!isCollapsed && (
            <Box mb={"25px"}>
              <Box display={"flex"} justifyContent={"center"} alignItems={"center"}>
                <img alt="profile-user" width="100px" height="100px" src={George} style={{ cursor: "pointer", borderRadius: "50%" }} />
              </Box>
              <Box textAlign={"center"} variant={"h2"} color={colors.grey[100]} fontWeight={"bold"} sx={{ m: "10px 0 0 0" }}>
